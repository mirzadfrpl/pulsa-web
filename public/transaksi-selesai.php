...
$sql = "SELECT * FROM pesanan_pulsa WHERE nama_pembeli = ? AND status_pesanan = 'selesai' AND waktu_dibuat >= NOW() - INTERVAL 1 HOUR ORDER BY waktu_dibuat DESC";
...
<body class="bg-gray-100 min-h-screen">
    ...
    <h2 class="mt-5">Pesanan Selesai...</h2>

    <?php if (empty($pesanan)): ?>
    <div class="text-center text-gray-500 italic mb-4">
        Pesanan Selesai sedang tidak ada.
    </div>
<?php else: ?>
...
<?php endif; ?>
    ...
    <div class="text-center mt-4"></div>
        <button class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600" onclick="window.location.href='./transaksi.php';">
